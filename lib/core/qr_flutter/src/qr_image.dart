...
import 'package:peniremit/core/qr_flutter/src/qr_painter.dart';
import 'package:peniremit/core/qr_flutter/src/qr_versions.dart';
import 'package:peniremit/core/qr_flutter/src/types.dart';
import 'package:peniremit/core/qr_flutter/src/validator.dart';
...
class _QrImageWidgetState extends State<QrImageWidget> {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      if (widget.embeddedImage != null) {
        ...
        return FutureBuilder<ui.Image>(
          future: _loadQrImageWidget(context, widget.embeddedImageStyle),
  ...
  Future<ui.Image> _loadQrImageWidget(
