...
class SpinFadingCircle extends StatefulWidget {
  ...
  @override
  State<SpinFadingCircle> createState() => _SpinFadingCircleState();
}

class _SpinFadingCircleState extends State<SpinFadingCircle> with SingleTickerProviderStateMixin {
